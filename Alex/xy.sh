...
(cd Alex; ./stock_ticker.py -y 2018 -m 8 -d 31 -t 9 | kcat -b kafkabroker -t stock_ticks -P)
...
(cd Alex; ./stock_ticker.py -y 2018 -m 8 -d 31 -t 10 | kcat -b kafkabroker -t stock_ticks -P)
